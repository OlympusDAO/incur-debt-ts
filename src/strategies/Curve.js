...
var Curve = /** @class */ (function () {
    ...
    Curve.prototype.getTokenADecimals = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.liquidityPool)
                            throw new Error("Liquidity pool not initialized");
                        return [4 /*yield*/, this.liquidityPool.coins(0)];
                    case 1:
    ...
    Curve.prototype.getTokenBDecimals = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.liquidityPool)
                            throw new Error("Liquidity pool not initialized");
                        return [4 /*yield*/, this.liquidityPool.coins(1)];
                    case 1:
    ...
    Curve.prototype.getReserveRatio = function () {
        return __awaiter(this, void 0, void 0, function () {
            var reservesA, tokenADecimals, reservesB, tokenBDecimals, isPrecisionEqual, isTokenAMorePrecise, decimalAdjustment_1, adjustedReservesB, decimalAdjustment, adjustedReservesA;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.liquidityPool)
