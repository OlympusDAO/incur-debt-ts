...
var IncurDebt = /** @class */ (function () {
    ...
    IncurDebt.prototype.encodeBorrowParameters = function (sender, strategy, lpAddress, slippage, ohmAmount, otherTokens, otherTokenAmounts) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var provider, strategies, UniStrategy, encodedParams, tx, BalancerStrategy, encodedParams, tx, CurveStrategy, encodedParams, tx;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(strategy == "uniswap" || strategy == "sushiswap")) return [3 /*break*/, 2];
                        UniStrategy = new Uniswap_1.Uniswap(lpAddress, slippage, ohmAmount, provider);
                        encodedParams = UniStrategy.getEncodedParams();
                    ...
                    case 2:
                        if (!(strategy == "balancer")) return [3 /*break*/, 4];
                        BalancerStrategy = new Balancer_1.Balancer(sender, lpAddress, otherTokens, otherTokenAmounts, slippage, ohmAmount, provider);
                        encodedParams = BalancerStrategy.getEncodedParams();
                        return [4 /*yield*/, this.contract.populateTransaction.createLP(ohmAmount, strategies[strategy], encodedParams)];
                    case 3:
                        tx = _a.sent();
                        return [2 /*return*/, tx.data];
                    case 4:
                        if (!(strategy == "curve")) return [3 /*break*/, 6];
                        CurveStrategy = new Curve_1.Curve(lpAddress, slippage, ohmAmount, provider);
                        encodedParams = CurveStrategy.getEncodedParams();
                        return [4 /*yield*/, this.contract.callStatic.createLP(ohmAmount, strategies[strategy], encodedParams)];
                    case 5:
                        tx = _a.sent();
                        return [2 /*return*/, tx.data];
